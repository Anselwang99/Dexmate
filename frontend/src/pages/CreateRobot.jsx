                    ...
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-gray-100 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors whitespace-nowrap"
                            >
                                Generate S/N
                            </button>
                        </div>
